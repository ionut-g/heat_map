...
let drawCells = () => {
    canvas.selectAll('rect')
        ...
        .attr('y', (item) => {
            return yScale(new Date(0, item['month'],-1,0,0,0,0,0)) - (height-(2*padding))/12
        })
        .attr('width', (item) => {
        ...
        .on('mouseover', (e) => {
            tooltip .transition() 
             ...
             console.log(baseTemp,'base temp')
             let a = tooltip.text(item['year']+' '+monthNames[item['month']-1]
...
req.onload = () => {
    ...
    drawCells()
    drawAxes()
    console.log(baseTemp,'base temp test')
